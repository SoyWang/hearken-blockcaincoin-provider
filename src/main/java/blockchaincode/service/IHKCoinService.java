...
public interface IHKCoinService {
	 ...
	 * @param path		证书文件根目录
	 */
	void award(String username,String amount,String path,String description) throws Exception;
	 ...
	 * @param path		证书文件根目录
	 */
	void recycle(String username,String amount,String path,String description) throws Exception;
